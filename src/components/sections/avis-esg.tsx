...
export function AvisEsg() {
  ...
  return (
    <section id="sustainability" className="py-24 bg-[#072C22] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {esgStats.map((stat, idx) => {
              const Icon = stat.icon;
              return (
                <motion.div
                  key={stat.title}
                  className="bg-[#0A3F30]/80 border border-emerald-500/20 rounded-2xl p-6 flex flex-col justify-between space-y-6 hover:border-emerald-400/50 transition-all group"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-emerald-300/70 italic mb-2">{stat.subtitle}</div>
                    <motion.div
